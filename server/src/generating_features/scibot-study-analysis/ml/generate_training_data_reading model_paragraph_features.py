...
from features import FixationEventWithReadingState, SaccadeEventWithReadingState, extract_features
from generate_training_data_convex_hull_features import FeatureExtractor
from data_loading.visit_extractor import ParagraphVisit
...
if __name__ == '__main__':
    ...
    dataloader = SciBot_DataLoader(data_dir=data_dir, exclude_users=["A02", "A05"], gaze_data=True, reading_task=True,

...
from .paragraph import ParagraphModel, ParagraphLayoutModel, ParagraphSchema, ParagraphLayoutSchema

class DocumentFeaturesModel(DocumentModel):

    def __init__(self, user_id: str, doc_id: str, paragraphs: List[ParagraphModel]):
        self._paragraphs = paragraphs
        super().__init__(self, user_id, doc_id)
...
class DocumentMixSchema(Schema):

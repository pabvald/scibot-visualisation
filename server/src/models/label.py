...
class LabelLayoutModel(LabelModel, Layout):

    def __init__(self, doc_id: str, label_id: int, text: str, x1: float, y1: float, x2: float, y2: float):
        LabelModel.__init__(self, label_id)
        Layout.__init__(self, doc_id, x1, y1, x2, y2)
        self._text = text

    @classmethod
    def from_data(cls, doc_id: str, mapping: any):
        """
        ...
        return cls(doc_id, label_id, text, x1, y1, x2, y2)
